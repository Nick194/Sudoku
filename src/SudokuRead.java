...
public class SudokuRead extends Sudoku {
     ...
     */
    public static Sudoku readSudoku(String file) throws IllegalArgumentException, IOException {
         ...
         * Finally a second for loop iterates through and changes the strings within readArray into ints and add them to a 2d int array called sudokuArray.
         * sudokuArray is then passed into the toString method and printed in the desired format.
         */
        ...
        try{
            ...
            for(int i = 0; i < 9; i++){
                ...
                for (int j = 0; j < 9; j++) {
                    ...
                    try{
                        sudokuArray[i][j] = Integer.parseInt(readArray[j]);
                    } catch (NumberFormatException e){
                        throw new IllegalArgumentException("Sudoku file contains an incompatible Character");
                    }
                }
            }
        ...
        Sudoku a1 = new Sudoku (sudokuArray);
